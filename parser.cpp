...
{
       0,    50,    50,    51,    54,    55,    58,    59,    62,    63,
      64,    67,    68,    69,    70,    73,    74,    75,    78,    79,
      80,    81,    82,    85,    86,    87,    90
};
#endif
...
static const char *const yytname[] =
{
  ...
  "TPLUS", "TMIN", "TMUL", "TDIV", "TLET", "TCOLON", "TEQUAL", "TSC",
  "TJUMP", "TCOMMA", "TCEQUAL", "TRBRACE", "TLBRACE", "TLPAREN", "TRPAREN",
  "TSTR", "$accept", "program", "stmts", "stmt", "var_decl", "expr",
  "call_args", "binary_ope_expr", "basics", "ident", YY_NULLPTR
};
#endif
...
{
       3,    -6,    -6,    -6,     7,     6,    -6,    19,     3,    -6,
      -6,    -4,    -6,    -6,    10,    12,    27,    -6,    -6,     6,
       6,     6,     6,     6,     7,     6,    -6,    33,    33,    -6,
      -6,    -4,    11,    40,    31,     6,    30,     6,    -6,    -6,
      -4,    -6,    42,    -6
};
...
{
       2,    23,    24,    26,     0,     0,    25,     0,     3,     4,
       6,     7,    11,    12,    14,     0,     0,     1,     5,     0,
       0,     0,     0,    15,     0,     0,    22,    18,    19,    20,
      21,    16,     0,     0,     0,     0,     0,     0,     8,    10,
      17,    13,     0,     9
};
...
{
      -6,    -6,    -6,    37,    -6,    -5,    -6,    -6,    -6,    -3
};

  /* YYDEFGOTO[NTERM-NUM].  */
static const yytype_int8 yydefgoto[] =
{
      -1,     7,     8,     9,    10,    11,    32,    12,    13,    14
};
...
{
      16,    15,    19,    20,    21,    22,     1,     2,     3,     1,
       2,     3,     3,     4,    27,    28,    29,    30,    31,    17,
      34,    33,     5,    24,     6,     5,    35,     6,    25,    23,
      40,    36,    42,    19,    20,    21,    22,    19,    20,    21,
      22,    21,    22,    41,    39,    18,     0,    26,    19,    20,
      21,    22,    37,    38,     0,    43
};
...
{
       5,     4,     6,     7,     8,     9,     3,     4,     5,     3,
       4,     5,     5,    10,    19,    20,    21,    22,    23,     0,
      25,    24,    19,    11,    21,    19,    15,    21,    16,    19,
      35,    20,    37,     6,     7,     8,     9,     6,     7,     8,
       9,     8,     9,    13,    13,     8,    -1,    20,     6,     7,
       8,     9,    12,    13,    -1,    13
};
...
{
       0,     3,     4,     5,    10,    19,    21,    23,    24,    25,
      26,    27,    29,    30,    31,    31,    27,     0,    25,     6,
       7,     8,     9,    19,    11,    16,    20,    27,    27,    27,
      27,    27,    28,    31,    27,    15,    20,    12,    13,    13,
      27,    13,    27,    13
};
...
#line 59 "parser.y" /* yacc.c:1646  */
    { (yyval.stmt) = new april::ExpressionStatement(*(yyvsp[0].expr)); }
...
#line 69 "parser.y" /* yacc.c:1646  */
    { (yyval.expr) = new april::MethodCall(*(yyvsp[-4].ident), *(yyvsp[-2].exprvec)); }
